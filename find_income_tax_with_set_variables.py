...
print('Your income is $'+ str(user_income), 'and your payable tax is')
...
if user_income in range (10000, 20001):
    ...
    print('($10000.0 * 0%) + ($'+str(income_tax),'* 10%) + ($0.0 * 2%) = $'+str(income_tax))

if user_income > 20000:
    income_tax = ((user_income-20000)*0.2)+(10000*0.1)
    print('($10000.0 * 0%) + ($10000.0* 10%) + ($'+str(user_income-20000), '* 2%) = $'+str(income_tax))
